...
def createDatasetDir(datasetPath, imagesPath, labelsPath, imagesTrainPath, imagesValPath, labelsTrainPath, labelsValPath, labelsPolyTrain, labelsPolyVal):
    if not os.path.exists(datasetPath):
        ...
        for i in range(len(imagesPath)):
            print(imagesPath[i])
            os.makedirs(imagesPath[i], exist_ok=True)
            os.makedirs(labelsPath[i], exist_ok=True)
        for i in range(len(imagesTrainPath)):
            os.makedirs(imagesTrainPath[i], exist_ok=True)
            os.makedirs(imagesValPath[i], exist_ok=True)
            os.makedirs(labelsTrainPath[i], exist_ok=True)
            os.makedirs(labelsValPath[i], exist_ok=True)
            os.makedirs(labelsPolyTrain[i], exist_ok=True)
            os.makedirs(labelsPolyVal[i], exist_ok=True)
    else:
        for i in range(len(imagesPath)):
